...
// SentinelNDRParser normalizes SentinelNDR JSON events into ECS.
...
type SentinelNDRParser struct{}

// NewSentinelNDRParser creates a new SentinelNDR parser.
func NewSentinelNDRParser() *SentinelNDRParser {
	return &SentinelNDRParser{}
}

// SourceType returns the source_type this parser handles.
func (p *SentinelNDRParser) SourceType() string {
	return "sentinel_ndr"
}

// --- NDR event envelope ---
// NDR events are pre-normalized to ECS by the SentinelNDR export pipeline.
...
// Parse validates and enriches a pre-normalized SentinelNDR event.
func (p *SentinelNDRParser) Parse(raw json.RawMessage) (*common.ECSEvent, error) {
	var env ndrEnvelope
	if err := json.Unmarshal(raw, &env); err != nil {
		return nil, fmt.Errorf("sentinel_ndr: unmarshal: %w", err)
	}
	...
	for _, w := range warnings {
		log.Printf("sentinel_ndr: %s: %s", env.EventType, w)
	}
...
func (p *SentinelNDRParser) validateSession(e *common.ECSEvent) []string {
	var warnings []string
...
func (p *SentinelNDRParser) validateDNS(e *common.ECSEvent) []string {
	var warnings []string
...
func (p *SentinelNDRParser) validateHTTP(e *common.ECSEvent) []string {
	var warnings []string
...
func (p *SentinelNDRParser) validateTLS(e *common.ECSEvent) []string {
	var warnings []string
	ensureCategory(e, []string{"network"})
	ensureType(e, []string{"protocol"})
	if e.Event.Action == "" {
...
func (p *SentinelNDRParser) validateSMB(e *common.ECSEvent) []string {
	var warnings []string
	ensureCategory(e, []string{"network"})
	ensureType(e, []string{"protocol"})
	if e.Event.Action == "" {
...
func (p *SentinelNDRParser) validateKerberos(e *common.ECSEvent) []string {
	var warnings []string
...
func (p *SentinelNDRParser) validateSSH(e *common.ECSEvent) []string {
	var warnings []string
	ensureCategory(e, []string{"network"})
	ensureType(e, []string{"protocol"})
	if e.Event.Action == "" {
...
func (p *SentinelNDRParser) validateSMTP(e *common.ECSEvent) []string {
	var warnings []string
	ensureCategory(e, []string{"network"})
	ensureType(e, []string{"protocol"})
	if e.Event.Action == "" {
...
func (p *SentinelNDRParser) validateRDP(e *common.ECSEvent) []string {
	var warnings []string
	ensureCategory(e, []string{"network"})
	ensureType(e, []string{"protocol"})
	if e.Event.Action == "" {
...
func (p *SentinelNDRParser) validateNTLM(e *common.ECSEvent) []string {
	var warnings []string
	ensureCategory(e, []string{"network", "authentication"})
	ensureType(e, []string{"protocol"})
	if e.Event.Action == "" {
...
func (p *SentinelNDRParser) validateLDAP(e *common.ECSEvent) []string {
	var warnings []string
	ensureCategory(e, []string{"network"})
	ensureType(e, []string{"protocol"})
	if e.Event.Action == "" {
...
func (p *SentinelNDRParser) validateDCERPC(e *common.ECSEvent) []string {
	var warnings []string
	ensureCategory(e, []string{"network"})
	ensureType(e, []string{"protocol"})
	if e.Event.Action == "" {
...
func (p *SentinelNDRParser) validateDetection(e *common.ECSEvent) []string {
	var warnings []string
	e.Event.Kind = "alert"
...
func (p *SentinelNDRParser) validateSignature(e *common.ECSEvent) []string {
	var warnings []string
	e.Event.Kind = "alert"
	ensureCategory(e, []string{"intrusion_detection"})
	ensureType(e, []string{"info"})
...
func (p *SentinelNDRParser) validateHostScore(e *common.ECSEvent) []string {
	var warnings []string
...
func (p *SentinelNDRParser) validateNetworkBase(e *common.ECSEvent, warnings []string) []string {
	if e.Source == nil {
		warnings = append(warnings, "missing source fields")
	}
	if e.Destination == nil {
